 ...
 * Pre-redesign Robot → Architecture tab (full-bleed layout, ROS HTTP API only).
 * Loaded when RobotUIFeatures::modern_architecture() === false.
 * Flag: robot_ui/modern_architecture (default true).
 * @see ../ui_features.php
 * @see README.md
 */
